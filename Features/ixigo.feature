Feature: More in Ixigo Website

Scenario: Plan in More
Given I am on the Ixigo Website
When I click on more 
And I click on Plan
Then it will redirect to the plan page

Scenario: Group Booking in More 
Given I am on the Ixigo Website
When I click on more 
And I click on Group Booking
Then it will redirect to the group booking page

Scenario: Book Visa in More
Given I am on the Ixigo Website
When I click on more
And I click on Book Visa
Then it will redirect to the Book Visa Page

Scenario: Customer Service Page
Given I am on the Ixigo Website
